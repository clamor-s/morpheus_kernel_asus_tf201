...
static int core_millivolts[MAX_DVFS_FREQS] = LP_MILLIVOLTS;
int avp_millivolts[MAX_DVFS_FREQS] = LP_MILLIVOLTS;
int lp_cpu_millivolts[MAX_DVFS_FREQS] = LP_MILLIVOLTS;
int emc_millivolts[MAX_DVFS_FREQS] = LP_MILLIVOLTS;
...
static struct dvfs core_dvfs_table[] = {
...
#ifdef CONFIG_TEGRA3_OVERCLOCK
 	CORE_DVFS("emc", emc_millivolts,    2, 1, KHZ,   102000, 450000, 450000, 450000, 450000,  667000,  667000,  677000,  667000),
#else
	...
	CORE_DVFS("vde", avp_millivolts,    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe", avp_millivolts,    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp", avp_millivolts,    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d", avp_millivolts,     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2", avp_millivolts,    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se", avp_millivolts,     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
#endif
...
#ifdef CONFIG_GPU_OVERCLOCK
#ifdef CONFIG_GPU_OC_332
	CORE_DVFS("host1x", avp_millivolts, 1, 1, KHZ,   100000, 167000, 167000, 167000, 167000,  167000,  167000,  167000,  167000),
#endif
#ifdef CONFIG_GPU_OC_446
	CORE_DVFS("host1x", avp_millivolts, 1, 1, KHZ,   100000, 152000, 188000, 223000, 223000,  223000,  223000,  223000,  223000),
#endif
#ifdef CONFIG_GPU_OC_484
	CORE_DVFS("host1x", avp_millivolts, 1, 1, KHZ,   100000, 152000, 188000, 242000, 242000,  242000,  242000,  242000,  242000),
#endif
#ifdef CONFIG_GPU_OC_520
	CORE_DVFS("host1x", avp_millivolts, 1, 1, KHZ,   100000, 152000, 188000, 222000, 260000,  260000,  260000,  260000,  260000),
#endif
#ifdef CONFIG_GPU_OC_600
	CORE_DVFS("host1x", avp_millivolts, 1, 1, KHZ,   100000, 152000, 188000, 222000, 254000,  300000,  300000,  300000,  300000),
#endif
#ifdef CONFIG_GPU_OC_666
	CORE_DVFS("host1x", avp_millivolts, 1, 1, KHZ,   100000, 152000, 188000, 222000, 254000,  333000,  333000,  333000,  333000),
#endif
#ifdef CONFIG_GPU_OC_700
	CORE_DVFS("host1x", avp_millivolts, 1, 1, KHZ,   100000, 152000, 188000, 222000, 254000,  350000,  350000,  350000,  350000),
#endif
#else
...
#ifdef CONFIG_GPU_OVERCLOCK
#ifdef CONFIG_GPU_OC_332
	CORE_DVFS("cbus", avp_millivolts,   1, 1, KHZ,   200000, 228000, 275000, 332000, 332000,  332000,  332000,  332000,  332000),
#endif
#ifdef CONFIG_GPU_OC_446
	CORE_DVFS("cbus", avp_millivolts,   1, 1, KHZ,   200000, 228000, 275000, 332000, 380000,  446000,  446000,  446000,  446000),
#endif
#ifdef CONFIG_GPU_OC_484
	CORE_DVFS("cbus", avp_millivolts,   1, 1, KHZ,   200000, 228000, 275000, 332000, 380000,  484000,  484000,  484000,  484000),
#endif
#ifdef CONFIG_GPU_OC_520
	CORE_DVFS("cbus", avp_millivolts,   1, 1, KHZ,   200000, 228000, 275000, 332000, 380000,  520000,  520000,  520000,  520000),
#endif
#ifdef CONFIG_GPU_OC_600
	CORE_DVFS("cbus", avp_millivolts,   1, 1, KHZ,   200000, 228000, 275000, 332000, 380000,  600000,  600000,  600000,  600000),
#endif
#ifdef CONFIG_GPU_OC_666
	CORE_DVFS("cbus", avp_millivolts,   1, 1, KHZ,   200000, 228000, 275000, 332000, 380000,  666000,  666000,  666000,  666000),
#endif
#ifdef CONFIG_GPU_OC_700
	CORE_DVFS("cbus", avp_millivolts,   1, 1, KHZ,   200000, 228000, 275000, 332000, 380000,  700000,  700000,  700000,  700000),
#endif
#else
	CORE_DVFS("cbus", avp_millivolts,   1, 1, KHZ,   200000, 228000, 275000, 332000, 380000,  416000,  416000,  416000,  416000),
#endif

#ifdef CONFIG_TEGRA3_OVERCLOCK
	CORE_DVFS("cbus", avp_millivolts,   2, 1, KHZ,   200000, 228000, 275000, 332000, 380000,  520000,  520000,  520000,  520000),
#else
	CORE_DVFS("cbus", avp_millivolts,   2, 1, KHZ,   200000, 247000, 304000, 352000, 400000,  437000,  484000,  520000,  600000),
#endif
	CORE_DVFS("cbus", avp_millivolts,   3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000,  484000),
